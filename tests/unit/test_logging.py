"""Validate nornir_pyntc logging works."""
import mock
import nornir_pyntc
...
def test_initialize_logging_default(get_logger, basic_cfg):
    ...
    nornir_pyntc.log.initialize_logging()
    ...
    assert get_logger.mock_calls[0].args == ("nornir_pyntc",)
...
def test_initialize_logging_user_defined_config(get_logger, basic_cfg):
    ...
    nornir_pyntc.log.initialize_logging(config=config)
...
def test_initialize_logging_filename(get_logger, basic_cfg):
    ...
    nornir_pyntc.log.initialize_logging(filename="output.log")
