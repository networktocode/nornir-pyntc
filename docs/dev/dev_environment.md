...
1. `Recommended` All services are spun up using Docker and a local mount so you can develop locally, but nornir-pyntc is spun up within the Docker container.
