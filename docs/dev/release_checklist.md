...
Draft a [new release](https://github.com/networktocode/nornir-pyntc/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @ntc_user in https://github.com/networktocode/nornir-pyntc/pull/123` -> `* @ntc_user`.
...
**Full Changelog**: https://github.com/networktocode/nornir-pyntc/compare/v1.4.1...v1.4.2
```
